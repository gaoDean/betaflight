...
// PG_GPS_CONFIG
    ...
    { PARAM_NAME_GPS_NMEA_CUSTOM_BAUD,       VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_BAUD_RATES }, PG_GPS_CONFIG, offsetof(gpsConfig_t, nmeaCustomTargetBaudIndex) },
